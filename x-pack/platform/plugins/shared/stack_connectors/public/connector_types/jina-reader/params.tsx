...
import type { JinaReaderActionConnector, ActionParams } from './types';
...
const ParamsFields: React.FunctionComponent<ActionParamsProps<ActionParams>> = ({
  ...
  const typedActionConnector = actionConnector as unknown as JinaReaderActionConnector;
  ...
  const editSubActionParams = useCallback(
    (params: Partial<ActionParams['subActionParams']>) => {
