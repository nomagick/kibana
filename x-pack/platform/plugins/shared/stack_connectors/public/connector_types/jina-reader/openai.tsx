...
import type { ActionParams, JinaReaderConnector } from './types';
...
export function getConnectorType(): JinaReaderConnector {
  return {
    id: JINA_READER_CONNECTOR_ID,
    iconClass: lazy(() => import('./logo')),
    selectMessage: i18n.translate('xpack.stackConnectors.components.jinaReader.selectMessageText', {
      defaultMessage: 'Browse or Search the Web using Jina Reader.',
    }),
    actionTypeTitle: JINA_READER_TITLE,
